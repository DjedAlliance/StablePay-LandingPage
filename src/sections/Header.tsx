...
export const Header = () => {
  ...
  return (
    <header className="py-3 sm:py-4 border-b border-white/15 md:border-none sticky top-0 z-50">
      ...
      <div className="container px-4 sm:px-6">
        <div className="flex justify-between items-center md:border border-white/15 md:p-2.5 rounded-xl max-w-2xl mx-auto relative">
          ...
          <div className="hidden md:block">
            <nav className="flex gap-4 lg:gap-8 text-sm" aria-label="Main navigation">
              {navLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 h-full w-[280px] bg-black border-l border-white/15 z-[70] md:hidden"
              role="dialog"
              aria-modal="true"
